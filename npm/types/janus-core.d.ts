...
interface Dependencies {
  newWebSocket(server: string, protocol: string): DependenciesOverrides['WebSocket'];
...
export default class Janus {
  ...
  static useDefaultDependencies(dependencies: Partial<DependenciesOverrides>): Dependencies;
  static useOldDependencies(dependencies: Partial<DependenciesOverrides>): Dependencies;
...
interface PluginCallbacks {
  ...
  mediaState(medium: 'audio' | 'video', startedOrStopped: boolean, mid: StreamId): void;
  ...
  onremotetrack(track: MediaStreamTrack, mid: StreamId, addedOrRemoved: boolean): void;
