...
export interface VideoroomJoinedMessage extends BaseMessage {
  videoroom: "joined";
  id: string;
  private_id: string;
...
export interface VideoroomPluginHandle extends PluginHandle {
  plugin: 'janus.plugin.videoroom'

  send<R extends VideoroomRequestName>(payload:
    VideoroomRequestMessage<R> &
    VideoroomResponseCallback<R> &
    { jsep?: JSEP }
  ): void;
